...
export const BrainCircuitIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 4.5v2.25c0 .385.223.73.563.896l2.378 1.189a.75.75 0 010 1.33l-2.378 1.189A1.125 1.125 0 0011.25 12v2.25c0 .385.223.73.563.896l2.378 1.189a.75.75 0 010 1.33l-2.378 1.189a1.125 1.125 0 00-.563.896V21M12.75 4.5v2.25c0 .385-.223.73-.563.896l-2.378 1.189a.75.75 0 000 1.33l2.378 1.189c.34.166.563.511.563.896v2.25c0 .385-.223.73-.563.896l-2.378 1.189a.75.75 0 000 1.33l2.378 1.189c.34.166.563.511.563.896V21M9 8.25h.008v.008H9V8.25zm.75 0h.008v.008H9.75V8.25zm.75 0h.008v.008h-.008V8.25zm.75 0h.008v.008h-.008V8.25zm.75 0h.008v.008h-.008V8.25zm.75 0h.008v.008h-.008V8.25zm.75 0h.008v.008h-.008V8.25zm.75 0h.008v.008h-.008V8.25zM9 15.75h.008v.008H9v-.008zm.75 0h.008v.008H9.75v-.008zm.75 0h.008v.008h-.008v-.008zm.75 0h.008v.008h-.008v-.008zm.75 0h.008v.008h-.008v-.008zM15 8.25a3 3 0 100 6 3 3 0 000-6z" />
...
// --- MEDALS & RANKING ICONS ---

export const MedalIcon: React.FC<IconProps & { tier: string }> = ({ tier, ...props }) => {
  const tierConfig: Record<string, { color: string, glow: string, path: string }> = {
    'iron': { color: '#6B7280', glow: 'rgba(107, 114, 128, 0.5)', path: 'M12 2L4 4V20L12 22L20 20V4L12 2Z' },
    'bronze': { color: '#D97706', glow: 'rgba(217, 119, 6, 0.5)', path: 'M12 2L4.5 5.5V18.5L12 22L19.5 18.5V5.5L12 2Z' },
    'silver': { color: '#9CA3AF', glow: 'rgba(156, 163, 175, 0.5)', path: 'M12 2L5 6V18L12 22L19 18V6L12 2Z' },
    'gold': { color: '#FCD34D', glow: 'rgba(252, 211, 77, 0.5)', path: 'M12 1L3 4.5V19.5L12 23L21 4.5V19.5L12 1Z' },
    'platinum': { color: '#38BDF8', glow: 'rgba(56, 189, 248, 0.5)', path: 'M12 1L2 5V19L12 23L22 19V5L12 1Z' },
    'diamond': { color: '#A855F7', glow: 'rgba(168, 85, 247, 0.5)', path: 'M12 1L2 7L12 23L22 7L12 1Z' },
    'vibe-master': { color: '#2DD4BF', glow: 'rgba(45, 212, 191, 0.6)', path: 'M12 0L0 5L12 24L24 5L12 0Z' },
    'medal-of-honor': { color: '#F87171', glow: 'rgba(248, 113, 113, 0.8)', path: 'M12 0L2 4V20L12 24L22 20V4L12 0ZM12 4L18 8V16L12 20L6 16V8L12 4Z' }
  };
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d={config.path} fill={config.color} filter={`url(#glow-${tier})`} />
      <path d={config.path} stroke="white" strokeOpacity="0.2" strokeWidth="0.5" />
    </svg>
  );
};

export const FounderBadge: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <circle cx="50" cy="50" r="45" stroke="#FCD34D" strokeWidth="2" strokeDasharray="4 2" />
    <path d="M50 20L58.22 36.64L76.54 39.3L63.27 52.24L66.4 70.47L50 61.85L33.6 70.47L36.73 52.24L23.46 39.3L41.78 36.64L50 20Z" fill="#FCD34D" />
    <path d="M50 10V25M90 50H75M10 50H25M50 90V75" stroke="#FCD34D" strokeWidth="3" strokeLinecap="round" />
  </svg>
);

export const WarStarterBadge: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <defs>
      <filter id="warStarterGlow" x="-50%" y="-50%" width="200%" height="200%">
        <feGaussianBlur stdDeviation="4" result="blur" />
        <feComposite in="SourceGraphic" in2="blur" operator="over" />
      </filter>
      <linearGradient id="warStarterGrad" x1="0%" y1="0%" x2="100%" y2="100%">
    ...
    {/* Divine Laurel */}
    <path d="M20 50C20 30 35 15 50 15C65 15 80 30 80 50C80 70 65 85 50 85C35 85 20 70 20 50" stroke="url(#warStarterGrad)" strokeWidth="2" strokeDasharray="5 3" />
    <path d="M10 50C10 25 30 5 50 5C70 5 90 25 90 50C90 75 70 95 50 95C30 95 10 75 10 50" stroke="url(#warStarterGrad)" strokeWidth="1" strokeOpacity="0.5" />

    {/* Double Interlocking Stars */}
    <g filter="url(#warStarterGlow)" className="animate-prestige-glow">
      <path d="M50 25L56 40L72 40L60 50L65 65L50 55L35 65L40 50L28 40L44 40L50 25Z" fill="url(#warStarterGrad)" />
      <path d="M50 35L54 45L64 45L56 52L59 62L50 55L41 62L44 52L36 45L46 45L50 35Z" fill="white" fillOpacity="0.8" />
    </g>

    {/* Radiance Rays */}
    <path d="M50 5V12M95 50H88M5 50H12M50 95V88M18 18L24 24M82 18L76 24M18 82L24 76M82 82L76 76" stroke="#FCD34D" strokeWidth="2" strokeLinecap="round" strokeOpacity="0.6" />
  </svg>
);
