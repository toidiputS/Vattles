...
const VattleArena: React.FC<VattleArenaProps> = ({ userProfile, userBattles, showcaseBattles, onEnterBattle, onSpectateBattle, onViewVattle, onJoinVattle, onWaitlist, onRequestBattle }) => {
